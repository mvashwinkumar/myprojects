...
namespace FinalizedProject
{
    public partial class Form_Transactions : Form
    {
        ...
        private void btn_ShowStatus_Click(object sender, EventArgs e)
        {
            ...
            cmShowStatus = new SqlCommand("select t.BookID, b.BookName, t.IssueDate, t.DueDate from [Tran] t left outer join Books b on t.BookID = b.BookID where MemberID = '" + txt_MemberID.Text + "' and Status = 'Out'", cnTransactions);
        ...
        {
            cnTransactions = new SqlConnection(connectionstring);
        ...
        private void btn_Loan_Click(object sender, EventArgs e)
        {
            ...
            daShowStatus.Update(dsShowStatus, "[Tran]");
        ...
        {
            cmShowStatus = new SqlCommand("select * from [Tran] where MemberID = '" +tempMemberID+ "' and Status = 'Out'", cnTransactions);
            daShowStatus = new SqlDataAdapter(cmShowStatus);
            cmb = new SqlCommandBuilder(daShowStatus);
            dsShowStatus = new DataSet();
            daShowStatus.Fill(dsShowStatus, "[Tran]");
